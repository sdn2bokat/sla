...
export default function PenerbitanSurat() {
  ...
  setProgress(10);
    try {
      const res = await fetch("/api/suratpip", {
        method: "POST",
  ...
  <nav className="flex" aria-label="Breadcrumb">
    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-[2fr_1fr] items-start gap-2 md:gap-4 justify-center">
        {/* KIRI */}
        <div>
        <div id="alert-additional-content-3" className="p-4 mb-4 text-green-800 border border-green-300 rounded-[18px] bg-green-50">
  <div className="flex items-center">
